...
"""
DATA_PATH_ORIG = "/home/satyarth934/data/modis_data_products/*/array_3bands_normalized/448/*"
DATA_PATH_MEAN = "/home/satyarth934/data/modis_data_products/terra/array_3bands_adapted/448/mean_stdev_removed/*"
DATA_PATH_MEDIAN = "/home/satyarth934/data/modis_data_products/terra/array_3bands_adapted/448/median_removed/*"
NORMALIZE = True
...
def main():
    ...
    img_paths = glob.glob(DATA_PATH_ORIG)
    img_paths.extend(glob.glob(DATA_PATH_MEAN))
    img_paths.extend(glob.glob(DATA_PATH_MEDIAN))
